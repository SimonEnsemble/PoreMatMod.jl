...
@test search1.results[1].isomorphism == [259, 284, 295, 272, 211, 220, 391, 355, 380, 368]
...
@test search2.results[1].isomorphism == [155, 170, 162, 179, 59, 66, 207, 208, 205, 206]
...
@test search3.results[1].isomorphism == [155, 170, 162, 179, 59, 66, 208, 205, 206, 207]
...
@test parent.atoms.species[search.results[1].isomorphism][1:4] == s_moty.atoms.species[1:4] &&
    s_moty.atoms.species[5] == :H! && parent.atoms.species[search.results[1].isomorphism][5] == :H
